...
{	
	...
	funcao inicio()
	{
		...
		inteiro x = 0, qtdeGrupo=0, turmas, resultadoGrupo=0
		para (x = 0; x <LIMITE; x++)
		{
			mat[x] = x+1
		}
		...
		pula()
		escreva("Digite a quantidade de pessoas por grupo: ")
		leia(qtdeGrupo)
		resultadoGrupo = LIMITE / qtdeGrupo
		para (x = 0; x < resultadoGrupo; x++){
